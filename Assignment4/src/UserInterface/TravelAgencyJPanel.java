...
//        list6.add("E");list6.add("A");list6.add("B");
        Flight flight6 = flightDir.addflight();
        flight6.setAirliner("Star Airline");
        flight6.setEstimation("null");
        flight6.setFlightnumber("u789");
        flight6.setID(list6);
        flight6.setFrom("boston");
        flight6.setTo("singapore");
        flight6.setFromtime(LocalTime.of(3,30,0));
        flight6.setTotime(LocalTime.of(13, 30, 0));
        String s11="19/03/2020";
        SimpleDateFormat f11=new SimpleDateFormat("dd/MM/yyyy"); 
        //Date d9=f9.parse(s9);
        String s12="20/03/2020";
        SimpleDateFormat f12=new SimpleDateFormat("dd/MM/yyyy"); 
        //Date d10=f10.parse(s10);
        flight6.setFromdate(s11);
        flight6.setTodate(s12);
    }
    /**
